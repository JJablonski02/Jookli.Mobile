...
export const postChangeEmail: (email: string) => Promise<void> = async (email: string) => {
    try{
        const token = await getAccessToken();
        const response = await axios.post(`api/userSettings/changeEmail`, email, {
            headers:{
                Authorization: `Bearer ${token}`,
            }
        });
...
export const postLanguageAndTimeZone: (settingsPreferencesLanguageTimeZone: any) => Promise<void> = async (settingsPreferencesLanguageTimeZone: any) => {
    try{
        const token = await getAccessToken();
...
export const postDisplayProfitAs: (settingsPreferencesDisplayProfitAs: any) => Promise<void> = async (settingsPreferencesDisplayProfitAs: any) => {
    try{
        const token = await getAccessToken();
        const response = await axios.post(`api/userSettings/displayProfitAs`, settingsPreferencesDisplayProfitAs, {
            headers:{
                Authorization: `Bearer ${token}`,
            }
        });
...
export const postSetDarkMode: (settingsPreferencesDarkMode: boolean) => Promise<void> = async (settingsPreferencesDarkMode: boolean) => {
    try{
        const token = await getAccessToken();
