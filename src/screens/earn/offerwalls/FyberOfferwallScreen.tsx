...
type EarnStackScreenProps = NativeStackScreenProps<EarnStackParamList, 'Fyber'>;

const FyberOfferwallScreen : React.FC<EarnStackScreenProps> = ({navigation}) => {
    const onClose = () => {
...
export default FyberOfferwallScreen;